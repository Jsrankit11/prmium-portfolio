...
export default function Hero() {
  ...
  const wordsEn = ['React Developer', 'Backend Developer', 'Data Analytics', 'AI Enthusiast'];
  const wordsHi = ['रिएक्ट डेवलपर', 'बैकएंड डेवलपर', 'डेटा विश्लेषक', 'एआई उत्साही'];
  const words = language === 'en' ? wordsEn : wordsHi;
  ...
  useEffect(() => {
    // Reset typing state on language change to avoid index mismatches
    setCurrentText('');
    setIsDeleting(false);
  ...
  const socialLinks = [
    ...
    { icon: <FaInstagram />, url: 'https://instagram.com/index_ankit', color: 'hover:text-[#e1306c] hover:border-[#e1306c]/50 hover:shadow-[0_0_15px_rgba(225,48,108,0.4)]' },
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 animate-fade-in-up">
          ...
          <motion.h1
            ...
            className="text-3xl min-sm:text-4xl sm:text-5xl md:text-6xl font-heading font-extrabold tracking-tight leading-tight text-white select-none"
          >
            Ankit Chaudhary
            <span className="block mt-3 text-transparent bg-clip-text bg-gradient-to-r from-neon-cyan via-blue-400 to-indigo-500 text-shadow-[0_0_30px_rgba(0,229,255,0.2)]">
              {t('hero_title_dev')} <br className="hidden sm:inline" />{t('hero_title_data')}
            </span>
          </motion.h1>
          ...
          >
            <span>{language === 'en' ? "I'm a " : "मैं हूँ एक "}</span>
          ...
          >
            ...
            <a
              ...
              download="Ankit_Chaudhary_Resume.pdf"
        ...
        >
          ...
          <div className="relative w-64 h-64 min-[375px]:w-72 min-[375px]:h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 animate-float-slow">
            ...
            <div className="absolute inset-0 rounded-[2rem] min-[375px]:rounded-[2.5rem] border border-neon-cyan/20 animate-[spin_20s_linear_infinite]" />
            <div className="absolute inset-2 min-[375px]:inset-3 rounded-[2rem] min-[375px]:rounded-[2.5rem] border border-blue-500/10 animate-[spin_15s_linear_infinite_reverse]" />

            {/* Main Cyber Glass Card */}
            <div className="absolute inset-4 min-[375px]:inset-6 rounded-[1.5rem] min-[375px]:rounded-[2rem] glass-panel p-4 min-[375px]:p-6 flex flex-col justify-between overflow-hidden shadow-[0_0_40px_rgba(0,229,255,0.05)] border-white/5">
              ...
              <div className="pt-3 border-t border-white/5 flex items-center justify-between text-left font-mono">
                ...
                <div className="text-right">
                  ...
                  <span className="text-xs text-neon-cyan font-bold">{t('hero_ssh_connected')}</span>
                </div>
              </div>
            </div>
